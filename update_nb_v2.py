...
# New source code for Cell 10 with Pipeline and StandardScaler
new_source = [
    "import time\n",
    ...
    "model = pipeline  # Keep variable name consistent for later cells\n",
    "\n",
...
print("Notebook updated with StandardScaler pipeline.")
